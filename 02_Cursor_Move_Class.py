...
fp.clear()
# jumpTo method
crs.jumpTo(qty=2, direction = fp.Move.DOWN);        print("I am down")
crs.jumpTo(qty=20, direction= "right");             print("I am right")
crs.jumpTo(1,fp.Move.UP);                           print("I am up")
crs.jumpTo(5,"down")
...
# jumpxy method
crs.jumpxy(0,0);     print("Start Here*")
