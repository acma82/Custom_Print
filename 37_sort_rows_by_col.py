...
result = pylo.sort_rows_by_col(data=lst, ref_col=0, reverse_order=False, update=False)
...
result = pylo.sort_rows_by_col(data=lst, ref_col=4, reverse_order=False, update=False)
tbl.print_fancy_format(result)

tbl.msg_title = "Sort_by Col 0. reverse_order=True, update=True"
result = pylo.sort_rows_by_col(data=lst, ref_col=0, reverse_order=True, update=True)
tbl.print_fancy_format(result)
...
tbl.msg_title = ""
lst_2 = [5,1,9,5]
result2 = pylo.sort_rows_by_col(data=lst_2, ref_col=10, reverse_order=False, update=False)
print("\n\nResult  : reverse_order=False, update=False")
tbl.print_fancy_format(result2)
print("Original:");  tbl.print_fancy_format(lst_2)

result2 = pylo.sort_rows_by_col(data=lst_2, ref_col=0, reverse_order=True, update=True)
