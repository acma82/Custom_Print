...
# Note: all_bg/fg/_corner takes priority over the others.
...
# Default Value
# div.top_horizontal_line_on   = True;  div.bottom_horizontal_line_on = True; div.horizontal_line_bold      = False
