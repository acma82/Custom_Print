...
result = pylo.num_to_str(data=lst, fill_value=None, update=False)
print("Result  :",result)
...
result = pylo.num_to_str(data=lst, fill_value=99, update=False)
print("Result  :",result)
...
result = pylo.num_to_str(data=lst, fill_value=None, update=True)
print("Result  :",result)
print("Original:",lst)